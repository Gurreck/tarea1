...
from cryptography.hazmat.primitives.asymmetric import padding as async_padding

# Configuración de la conexión
MIXNET_HOST = "pets.ic-itcr.ac.cr"
MIXNET_PORT = 50028  # Puerto ficticio, actualizar con el real
...
def onion_encrypt(dest, message, keys):
    ...
    for key in reversed(keys):  # Cifrar en orden mix-3 -> mix-2 -> mix-1
        ...
        plaintext = encrypt_rsa(key, iv+aes_key) + plaintext
